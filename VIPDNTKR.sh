print "          _nnnn_       _________________"
print "        dGGGGMMb      |                 |"
print "       @p~qp~~qMb   ._| VIP DNT         |"
print "       M(@)(@) M|  /  |_________________|"
print "       @,----.JM|_/"
print "      JS^\__/  qKL"
print "     dZP        qKRb"
print "    dZP          qKKb"
...
SSAD="/data/media/0/Android/data/tk.pubgm.dnt/tmp"
SS="/storage/emulated/0/Fendy"
...
GETSDK=$(getprop ro.build.version.sdk)
WM="[1;34m DOG NOTEAM [0m 
[1;32m $DEVICE [0m 
[1;32m Brand Device: [0m $BRAND 
[1;32m OS Version: [0m $BUILDVERSION 
[1;32m $DATEX [0"
alias BB="busybox"
...
BBR -rf $DD/$PN/lib/libtersafe.so
BBR -rf $DD/$PN/lib/libtprt.so
BBR -rf $DD/$PN/lib/libUE4.so
BBD if=/dev/urandom of=$DD/$PN/lib/libgcloud.so bs=5000 count=50 &> /dev/null
BBD if=/dev/urandom of=$DD/$PN/lib/libtersafe.so bs=19276 count=50 &> /dev/null
BBD if=/dev/urandom of=$DD/$PN/lib/libtprt.so bs=1000 count=50 &> /dev/null
BBD if=/dev/urandom of=$DD/$PN/lib/libUE4.so bs=19276 count=50 &> /dev/null
BBE -e "$BBlue GENERATOR LIB & PERMISION $COff"
BBCHM -R 755 $DD/$PN/lib/libgcloud.so
BBCHM -R 755 $DD/$PN/lib/libtersafe.so
